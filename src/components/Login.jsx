  ...
  return (
    <div className="w-full h-full flex flex-col font-outfit justify-center items-center bg-[#F0EAD6] gap-12">
      ...
      <div className="w-220 aspect-video bg-white  rounded-4xl flex justify-center items-center shadow-xl shadow-gray-400/80">
        {/* Blue Box */}
        <div className="w-1/2 h-full rounded-4xl bg-[#344b75] flex flex-col justify-center items-center gap-14">
        ...
        {/* Login form */}
        <div className="w-1/2 h-full flex flex-col justify-center items-center text-black gap-14">
          <div className="text-4xl font-extrabold tracking-wider text-shadow-black">
            LOG IN
          </div>
          <form
            action=""
            ...
            <div className="flex flex-col justify-center items-center gap-6">
              <div className="relative flex justify-center items-center">
                ...
                <input
                  type="email"
                  placeholder="Email"
                  className="w-72 p-3 pr-9 bg-gray-400/35 text-black text-lg rounded-md shadow-lg shadow-inherit outline-none"
                  required
                />
